                    ...
                    {flatCategories.map(({ cat, depth }) => (
                      <div key={cat.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-joy-gray-50 transition-colors" style={{ paddingLeft: `${depth * 24 + 12}px` }}>
                        <div className="flex items-center gap-2 flex-1">
                          {depth === 0 && <span className="text-joy-gray-400"><Icons.Package size={18} /></span>}
                        ...
                        <div className="flex items-center gap-1">
                          {depth < 3 && (
                            <button onClick={() => openAddCategory(cat.id)} className="p-2 hover:bg-joy-orange/10 rounded-lg text-joy-orange" title="Add subcategory">
                              <Icons.Plus size={16} />
                            </button>
                          )}
                          <button onClick={() => openEditCategory(cat)} className="p-2 hover:bg-joy-gray-100 rounded-lg" title="Edit">
