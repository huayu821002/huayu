...
export default function ProductsPage() {
  ...
  const activeCategory = params.category || selectedCategory
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <aside className={cn(
              ...
              {/* Price Range */}
              <div className="bg-white rounded-xl border border-joy-gray-100 p-4 mb-6">
                <h3 className="font-semibold text-joy-gray-900 mb-4">Price Range</h3>
                <div className="flex items-center gap-2">
                  <Input type="number" placeholder="Min" className="text-sm" />
                  <span className="text-joy-gray-400">-</span>
              ...
              <div className="bg-white rounded-xl border border-joy-gray-100 p-4">
                <h3 className="font-semibold text-joy-gray-900 mb-4">Compliance</h3>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="lg:hidden p-2.5 rounded-xl border-2 border-joy-gray-200"
                  >
